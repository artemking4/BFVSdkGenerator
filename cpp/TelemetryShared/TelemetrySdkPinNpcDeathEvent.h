// Object: TelemetrySdkPinNpcDeathEvent
// ClassId: 5095
// RuntimeId: 24233
// TypeInfo: 0x0000000144F5A8E0
...
namespace TelemetryShared {
    class TelemetrySdkPinNpcDeathEvent : public TelemetryShared::TelemetrySDKPinEvent {
        Uint32 gdur; // 0x100
        Uint32 rdur; // 0x104
        char pad_0x108[0x8];
    ...
    static_assert(sizeof(TelemetrySdkPinNpcDeathEvent) == 0x1D0);
}
#pragma pack(pop)